...
"background-color: rgb(255, 170, 0);")
        ...
        spacerItem27 = QtWidgets.QSpacerItem(20, 50, QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        self.verticalLayout_14.addItem(spacerItem27)
        self._2.addWidget(self.chatUserBox)
        self.chatting = QtWidgets.QTextBrowser(self.chatBox)
